...
import android.zxing.camera.CameraManager;
...
public final class ViewfinderView extends View {
  ...
  public void onDraw(Canvas canvas) {
    ...
    if (resultBitmap != null) {
      ...
      middle += 2;
      middle %= frame.height();
      canvas.drawRect(frame.left + 2, middle + frame.top - 1, frame.right - 1, middle + frame.top + 2, paint);
